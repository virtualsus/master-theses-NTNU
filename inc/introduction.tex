...
%Creating guidelines for such interfaces is an important issue that needs to be keenly focused on. Primarily, designers and developers need to understand the challenges within gestural design and ensure that gestural touchless interfaces are Designed for All1, with good user experience.
