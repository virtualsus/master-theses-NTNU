...
\section{Interview}
\label{sec:interview}
Interviews are an essential part for this research in order to  gain a deeper understanding and  a good overview regarding ASD test and screening methods that are used by medical personnel nowadays. Additionally, information about the assessment of motor coordination skills used in norway were of great importance.
For that reason a semi- structured interview was conducted. This type of  interview is a widely used qualitative research method.  The biggest advantage here is that the topic will be explored by questions that are open ended with a possibility of a follow up question. This will give the possibility to draw out more information from the interviewee.  (book research methods Lazar. S 189)
It was surprisingly challenging to find people who have some kind of experience in the field of ASD. However, two 2 volunteers with medical background and background in school/kindergarten could be recruited for this purpose. 

The participants were informed about the nature of the study and their right to withdraw at any time (Ref. book practical research, Leedy). Additionally, it was made clear at all information gained from the interview were kept confidential. 
The interviews were conducted at times and place that suited the participant. 
At the end a thank you message and an offer to provide a copy of the report was sent to follow up after the interview.



Interview #1
The first person who i was able to interview in form of a brief conversation was a after school care provider. She is employed in a primary school in Berlin (Germany) for some years already. During their education they learned about characteristics that defines autism in early childhood. The interview was conducted via skype and lasted about 15 min. It was hard to stick to the predefined questions since the interviewee had no experience in screening methods for ASD. However, the interview gave some useful insides of how autism is handled in school environment. She mentioned that they do not test children for ASD in preschool, however in case of observed abnormalities they will talk to the parents and recommend a further investigation with a psychologist specialized in child behaviour and development.
With abnormal behaviour she  meant, children with characteristics such as language delay, mislike of body contact, mislike of noise and difficulties in understanding face mimic.
To the question why they do not conduct a screening on children in generell, she answered that there is no capacity for that.
...
The Leap Motion device was purchased second hand on www.finn.no. The V2 desktop tracking installation files which included the SDK version v2.3.1 were downloaded from www.leapmotion.com . The installation was straightforward and the device could immediately be connected to the PC and used with the Leap Motion visualizer.
...
The data gained during this task is than used for further evaluation.
